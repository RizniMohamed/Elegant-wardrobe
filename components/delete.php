                        ...
                        <div class="max-w-md w-full space-y-4">
                            ...
                            <div>
                                ...
                                <div class="flex justify-end mt-10">
                                    ...
                                    <button onclick="hideDelete();showSuccess('Deleted successfully')" type=" submit" class=" w-24 flex justify-center py-1 text-sm font-medium rounded-md text-white bg-gray-600 hover:bg-red-700 focus:outline-none">
                                        Yes
                                    </button>
                                </div>
                            </div>
