...
<div class="flex flex-col justify-center mx-10 mb-10  p-5 rounded-lg">
    <button onclick="showAddProduct(3,1)" class="font-bold text-lg mb-5 flex">Clothing <i class="fa-solid fa-circle-plus text-2xl translate-y-1 ml-2 hover:text-green-600 cursor-pointer"></i></button>
...
<!-- Footwear  -->
<div class="flex flex-col justify-center mx-10 mb-10  p-5 rounded-lg">
    <button onclick="showAddProduct(3,2)" class="font-bold text-lg mb-5 flex">Footwear <i class="fa-solid fa-circle-plus text-2xl translate-y-1 ml-2 hover:text-green-600 cursor-pointer"></i></button>
    <div class=" mt-1  rounded-md py-2  flex w-full justify-around  border-2 border-gray-200 ">
        <p class=" w-20 text-md text-center font-bold ">Image</p>
        <p class=" w-96 text-md text-center font-bold ">Name</p>
        <p class=" w-20 text-md text-center font-bold ">Quantity</p>
...
<!-- Accessorites  -->
<div class="flex flex-col justify-center mx-10 mb-10  p-5 rounded-lg">
    <button onclick="showAddProduct(3,3)" class="font-bold text-lg mb-5 flex">Accessories <i class="fa-solid fa-circle-plus text-2xl translate-y-1 ml-2 hover:text-green-600 cursor-pointer"></i></button>
    <div class=" mt-1  rounded-md py-2  flex w-full justify-around  border-2 border-gray-200">
        <p class=" w-20 text-md text-center font-bold ">Image</p>
        <p class=" w-96 text-md text-center font-bold ">Name</p>
        <p class=" w-20 text-md text-center font-bold ">Quantity</p>
