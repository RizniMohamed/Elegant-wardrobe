...
<body>
    ...
    <div id="cart_items" class="flex  flex-col m-10 bg-gray-300 p-5 rounded-lg">
        ...
        <div id="order_header" class=" mt-1  rounded-md py-2 shadow-xl flex w-full justify-around bg-gray-400">
